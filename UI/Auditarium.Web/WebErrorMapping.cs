...
public static class WebErrorMapping
{
    ...
    private static string MessageFor(AppError error) => error.Code switch
    {
        ...
        "AUTHENTICATION.PASSWORD_POLICY_VIOLATION" => "Das neue Passwort erfüllt die lokale Passwort-Policy nicht oder ist als häufig verwendetes beziehungsweise kompromittiertes Passwort gesperrt.",
        "AUTHENTICATION.PASSWORD_CHANGE_CONFLICT" => "Das Passwort wurde inzwischen geändert. Melden Sie sich erneut an.",
        ...
        "LOCAL_CREDENTIAL.IDENTITY_ALREADY_EXISTS" => "Der Benutzer besitzt bereits eine lokale Identität.",
        "LOCAL_CREDENTIAL.SYSTEM_MANAGED" => "Das Credential des Default-Administrators kann nur durch ihn selbst oder über den Recovery-Prozess geändert werden.",
        "LOCAL_CREDENTIAL.CONCURRENCY_CONFLICT" => "Das lokale Credential wurde inzwischen geändert. Laden Sie die Seite neu.",
        ...
        "JOB.NOT_FOUND" => "Der angeforderte Job ist nicht bekannt.",
        "JOB.DISABLED" => "Der Job ist deaktiviert.",
        "JOB.TRIGGER_NOT_ALLOWED" => "Dieser Job darf nicht manuell gestartet werden.",
        "JOB.ALREADY_RUNNING" => "Der Job läuft bereits und wurde nicht erneut gestartet.",
