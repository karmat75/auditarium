...
public static class CatalogEndpoints
{
    ...
    private static Task<IResult> DeleteElement(IMediator mediator, long elementId, [FromBody] ConfirmContract contract, CancellationToken ct) => Send(mediator.Send(new DeleteDocumentElementCommand(elementId, contract.Confirmed), ct));
    ...
    private static Task<IResult> DeleteQuestion(IMediator mediator, long questionId, [FromBody] ConfirmContract contract, CancellationToken ct) => Send(mediator.Send(new DeleteQuestionCommand(questionId, contract.Confirmed), ct));
