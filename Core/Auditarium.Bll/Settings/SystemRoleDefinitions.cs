...
public static class SystemRoleDefinitions
{
    ...
    [
        ...
        new("AUDIT_MANAGER", "Audit Manager", "Verwaltet Regelwerke, Prüfeinheiten und Audits.", Set("Documents.Manage", "Documents.Delete", "AuditUnits.Manage", "AuditUnits.Delete", "Audits.Create", "Audits.UpdateDraft", "Audits.Publish", "Audits.Assign", "Audits.Cancel", "Audits.Reopen", "Audits.Read", "Audits.ReadFinalized", "Audits.Evaluate", "Audits.Delete", "Reports.Export", "AuditHistory.Read")),
        ...
        new("SYSTEM_INTERNAL", "System Internal", "Minimalrolle für kontrollierte interne Prozesse.", Set("Maintenance.Retention.Execute"))
    ];
}
