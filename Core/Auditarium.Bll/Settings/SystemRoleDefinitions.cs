...
public static class SystemRoleDefinitions
{
    ...
    [
        new("SYSTEM_ADMIN", "System Administrator", "Verwaltet Benutzer, Rollen, Authentifizierung und technische Einstellungen.", Set("Users.Manage", "Roles.Manage", "Authentication.Manage", "Settings.Manage", "AuditHistory.Read")),
