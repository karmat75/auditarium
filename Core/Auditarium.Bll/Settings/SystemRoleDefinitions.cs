...
public static class SystemRoleDefinitions
{
    ...
    [
        new("SYSTEM_ADMIN", "System Administrator", "Verwaltet Benutzer, Rollen, Authentifizierung und technische Einstellungen.", PermissionDefinitions.All.Select(x => x.Key).ToHashSet(StringComparer.Ordinal)),
