...
public sealed class AuditUnit { public long AuditUnitId { get; set; } public long? ParentAuditUnitId { get; set; } public long ScopeTypeId { get; set; } public required string Name { get; set; } public string? Description { get; set; } public AuditUnitUsageState UsageState { get; set; } = AuditUnitUsageState.Active; public string? UsageStateReason { get; set; } public string? Notes { get; set; } public DateTimeOffset? DeletedAt { get; set; } public long? DeletedBy { get; set; } public string? DeletionReason { get; set; } public long ConcurrencyVersion { get; set; } = 1; }
public sealed class Audit { public long AuditId { get; set; } public long? OriginAuditId { get; set; } public required string Name { get; set; } public string? Description { get; set; } public long AuditUnitId { get; set; } public long CatalogVersionId { get; set; } public string? AuditUnitContext { get; set; } public AuditState AuditState { get; set; } = AuditState.Draft; public string? StateReason { get; set; } public long? AssignedAuditorUserId { get; set; } public required string AuditSettings { get; set; } public DateTimeOffset CreatedAt { get; set; } public string? Notes { get; set; } public DateTimeOffset? DeletedAt { get; set; } public long? DeletedBy { get; set; } public string? DeletionReason { get; set; } public long ConcurrencyVersion { get; set; } = 1; }
