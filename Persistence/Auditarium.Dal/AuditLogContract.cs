...
{
    private static readonly HashSet<string> Actions = ["CREATED", "UPDATED", "PURGED", "LOGIN", "LOGIN_FAILED", "LOGOUT", "ACCESS_DENIED"];
    private static readonly HashSet<string> ObjectTypes = ["User", "AuthenticationProvider", "UserIdentity", "LocalCredential", "ApiCredential", "Permission", "Role", "RolePermission", "UserRole", "ApplicationSetting", "Authentication", "Authorization"];
