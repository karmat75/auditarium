...
{
    private static readonly HashSet<string> Actions = ["CREATED", "UPDATED", "DELETED", "RESTORED", "PURGED", "STATE_CHANGED", "LOGIN", "LOGIN_FAILED", "LOGOUT", "ACCESS_DENIED", "JOB_TRIGGERED"];
