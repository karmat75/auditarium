...
{
    private static readonly HashSet<string> Actions = ["CREATED", "UPDATED", "PURGED", "STATE_CHANGED", "LOGIN", "LOGIN_FAILED", "LOGOUT", "ACCESS_DENIED"];
    private static readonly HashSet<string> ObjectTypes = ["User", "AuthenticationProvider", "UserIdentity", "LocalCredential", "ApiCredential", "Permission", "Role", "RolePermission", "UserRole", "ApplicationSetting", "Document", "CatalogVersion", "DocumentElement", "DocumentElementWeight", "Question", "FileItem", "Authentication", "Authorization"];
