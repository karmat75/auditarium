        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    save_file_name = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    extension = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    save_file_path = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    catalog_state = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    draft_revision = table.Column<int>(type: "int", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    created_by = table.Column<long>(type: "bigint", nullable: false),
                    notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    verification_hint = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    evidence_hint = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    notes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
